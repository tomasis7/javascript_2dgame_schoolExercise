...
// Array to store room loading functions
const roomLoaders = [
  loadRoom0Scene,
  loadRoom1Scene,
  loadRoom2Scene,
...
function main() {
  ...
  function loadStartScene(container) {
    ...
    image1.onclick = () => {
      if (input.value.trim() === "") {
        ...
        key4Found = false;
        roomIndex = 0;
        roomLoaders[roomIndex](container);
      }
    };
  ...
  roomImage0.src = `images/${roomImages[roomIndex]}`;
...
function loadRoom1Scene(container) {
  ...
  roomImage1.src = `images/${roomImages[roomIndex]}`;
...
function loadRoom3Scene(container) {
  ...
  roomImage3.src = `images/${roomImages[roomIndex]}`;
...
function loadRoom4Scene(container) {
  ...
  roomImage4.src = `images/${roomImages[roomIndex]}`;
...
function loadFinalRoom(container) {
  ...
  finalRoomImage.src = "images/finalroom.gif";
